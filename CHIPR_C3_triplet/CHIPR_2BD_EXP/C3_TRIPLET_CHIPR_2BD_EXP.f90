...
! RMSD=2.7 kJ MOL-1
!
! THIS VERSION IS THE MIXED EXPERIMENTAL/THEORETICAL PES (DENOTED AS CHIPR-2BD-EXP)
!
...
!######################################################################################################
      ...
      V1(2)=DIAT2(R2)
      V1(3)=DIAT3(R3)
      CALL CHIPR_C2SIGPS_EXP(R1,V2(1),DER,DVDR1)
      CALL CHIPR_C2SIGPS_EXP(R2,V2(2),DER,DVDR2)
      CALL CHIPR_C2SIGPS_EXP(R3,V2(3),DER,DVDR3)
