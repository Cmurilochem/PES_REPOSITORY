...
C###############################################################################
C TOTAL ENERGY-SWITCHING POTENTIAL
C###############################################################################
      ...
      EMIN=-0.5227686755824460000D+00 ! SUM OF DE OF DIATOMIC PLUS GROUND STATE ENERGY
...
C###############################################################################
      ...
      DOUBLE PRECISION, DIMENSION(3)  :: R                                    ! BOHRS
      ...
      DOUBLE PRECISION, PARAMETER :: RE=1.2939700000000000000000D+00          ! ANGS
      DOUBLE PRECISION, PARAMETER :: VREF=-0.5227686755824460000D+00          ! SUM OF DE OF DIATOMIC PLUS GROUND STATE ENERGY - A.U
      DOUBLE PRECISION, PARAMETER :: ANGMAX=100.0000000000000000D+00          ! DEGS
      DOUBLE PRECISION, PARAMETER :: WALL=0.00000000000000000000D+00          ! A.U
      ...
      ELSE
        ...
        F2=VECDIST(POSIT)
      END IF
      COSTHETA=((F3**2-F1**2-F2**2)/(-2.00D+00*F1*F2))                       ! BRUTE-FORCE PERMUTATION - ALWAYS CHANNEL #3
      ...
      IF (DTHETA>(ANGMAX*PI/DEG)) THEN
        LP=V+VREF                                                 ! LP=WALL FOR DVR VIBRATIONAL CALCULATIONS
      ELSE
        LP=V+VREF
      END IF
